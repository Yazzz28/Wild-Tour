...
<header class="centrer">
    ...
    <main>
        ...
        <section class="col-2 gradient-right">
            <div class="col2-2">
                <img class="img-square" src="/assets-julien/IMG_4109-2.jpg" ;>
            </div>
            <div class="col2-1">
        ...
        <section>
            <div>
                <img class="img-paysage" src=" /assets-julien/expo-dali-gaudi-bordeaux.jpg" ;>
            </div>
        </section>
